...
protocol AuthenticationServiceType {
    func checkAuthenciationState() -> String?
...
class StubAuthenticationService: AuthenticationServiceType {
    ...
    func handleSignInWithAppleCompletion(_ authorization: ASAuthorization, nonce none: String) -> AnyPublisher<User, ServiceError> {
        Empty().eraseToAnyPublisher()
    }
